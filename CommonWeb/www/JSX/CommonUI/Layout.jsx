...
class Layout extends React.Component {
  ...
  initBind() {
    ...
    this.handleCloseLoginDialogCallback = this.handleCloseLoginDialogCallback.bind(
      this
    );
  }
    ...
    if (profile === null) {
      return (
        <React.Fragment>
          ...
          <RButton
            text="Login"
            className="layout-user-info-login-btn"
        ...
        return (
          <React.Fragment>
            <img
              ...
              className="layout-user-info-pic"
      ...
      case Util.LOGIN_TYPE.Account:
        return (
          <React.Fragment>
            <span
              onClick={this.handleLogout}
              className="fi-page-user-a layout-user-info-pic"
            ></span>
            <span className="layout-user-info-desc account">
              {profile.username}
            </span>
          </React.Fragment>
        );
      ...
      <div id={this.props.id} className="layout">
        <div className="layout-container">
          ...
          <div className="layout-header-info">
            ...
            <div className="layout-header-info-sub">
              Welcome to Dqhan's Blog
            </div>
            <div className="layout-header-info-link">
              <ul>
                <li>
                  <a
                    className="font-icon iconfont icon-github"
                    href="https://github.com/Dqhan"
                    target="_blank"
                  ></a>
                </li>
                <li>
                  <a
                    className="font-icon iconfont icon-CN_cnblogs"
                    href="https://www.cnblogs.com/moran1992/"
                    target="_blank"
                  ></a>
                </li>
                <li>
                  <a
                    className="font-icon iconfont icon-weixin"
                    href="https://www.dqhanhouse.com"
                    target="_blank"
                  ></a>
                </li>
              </ul>
            </div>
            <div className="layout-user-info">{this.renderInfo()}</div>
          </div>
          <div className="layout-main">
            <div className="layout-main-content">{this.props.children}</div>
          </div>
        </div>
