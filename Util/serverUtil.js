...
module.exports = {
  ...
  whiteList: [
    ...
    '/user/api/resetpwd',
    '/user/api/deluser',
    '/article/api/addarticle',
    '/article/api/delarticle',
    '/article/api/putarticle',
    '/article/api/getartcile',
    '/article/api/getartciles',
    '/deliver/api/adddeliver',
    '/deliver/api/deldeliver',
    '/deliver/api/putdeliver',
    '/deliver/api/getdelivers',
    '/leavemsg/api/addmsg',
    '/leavemsg/api/delmsg',
    '/leavemsg/api/putmsg',
