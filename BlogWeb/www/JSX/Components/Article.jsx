...
export default class Article extends React.Component {
    ...
    retrieveArticles(resolve, reject) {
        ...
        // myHeaders.append('R.Content-Type','application/x-www-form-urlencoded');
        // myHeaders.append('','');
        // var myInit = {
        //     method: 'GET',
        //     headers: myHeaders,
        ...
        //     cache: 'default'
        // };
        // var myRequest = new Request(`./article/api/getartcile?id=${id}`, myInit);
        // myRequest.then(res => {
        //     $$.loading(false);
        //     if (toString.call(resolve) === '[object Function]') resolve(res);
        //     else this.retrieveArticlesCallback(res);
    ...
    retrieveDelivers(resolve, reject) {
        let id = getUrlParamster().id;
        let option = {
            url: `./blog/api/getdelivers?id=${id}`,
            method: 'GET'
        }
        $$.loading(true);
        fetchUtility(option).then(res => {
