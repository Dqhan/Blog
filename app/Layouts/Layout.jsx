...
export default class Layout extends React.Component {
    ...
    initBind() {
        ...
        $Scope.register('logincallback', this.handleCloseLoginDialog.bind(this));
    }
    ...
    changeLogin(type) {
        this.setState({
            ...
            if (this.state.loginType == LoginType.WeChart)
                this.initWeChat();
        });
    }
    ...
    render() {
        return <div id={this.props.id} className='layout'>
            ...
            <$$.Dialog
                ...
                width={400}
                height={400}
                status={this.state.loginDialogStatus}
                foot={[
                    {
                        text: "close",
                        click: this.handleCloseLoginDialog
                    },
                    {
                        text: "ok",
                        click: this.handleOKLoginDialog
                    }
                ]}
            >
